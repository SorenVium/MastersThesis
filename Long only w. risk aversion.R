...
Baseline <- add.objective(Baseline, type="quadratic_utility", risk_aversion=ra)
...
Index1_1 <- add.objective(Index1_1, type="quadratic_utility", risk_aversion=ra)
...
Index2_1 <- add.objective(Index2_1, type="quadratic_utility", risk_aversion=ra)
...
Index3_1 <- add.objective(Index3_1, type="quadratic_utility", risk_aversion=ra)
...
Index4_1 <- add.objective(Index4_1, type="quadratic_utility", risk_aversion=ra)
...
Index5_1 <- add.objective(Index5_1, type="quadratic_utility", risk_aversion=ra)
...
Index6_1 <- add.objective(Index6_1, type="quadratic_utility", risk_aversion=ra)
...
Index7_1 <- add.objective(Index7_1, type="quadratic_utility", risk_aversion=ra)
...
Index8_1 <- add.objective(Index8_1, type="quadratic_utility", risk_aversion=ra)
...
Index9_1 <- add.objective(Index9_1, type="quadratic_utility", risk_aversion=ra)
...
Index10_1 <- add.objective(Index10_1, type="quadratic_utility", risk_aversion=ra)
...
Index11_1 <- add.objective(Index11_1, type="quadratic_utility", risk_aversion=ra)
...
Index12_1 <- add.objective(Index12_1, type="quadratic_utility", risk_aversion=ra)
...
write.table(rets1_df, file = "Risk long only returns.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
...
#Export results
write.zoo(Exportweights, file = "Long only w. risk aversion weights.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.table(Returns, file = "Long only w. risk aversion mean returns.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.table(Returns_Annual, file = "Long only w. risk aversion Annual returns.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.table(Std.annual, file = "Long only w. risk aversion Annual std..txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.table(Sharpe_Annual, file = "Long only w. risk aversion Annual sharpe.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(Treynor_Annual, file = "Treynor Long only w. risk aversion.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(Alphadf, file = "Alpha Long only w. risk aversion.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(Returns_excess, file = "Excess montly Long only w. risk aversion.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(Returns_excess_Annual, file = "Annual Excess Long only w. risk aversion.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(Std.dev_excess_Annual, file = "Annual Excess std Long only w. risk aversion.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(maxreturn, file = "Maxreturn Long only w. risk aversion.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(minreturn, file = "Minreturn Long only w. risk aversion.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(maxdrawdown, file = "MaxDrawdown Long only w. risk aversion.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(losing, file = "Losing months Long only w. risk aversion.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
