...
Baseline <- add.constraint(Baseline, type = "long_only")
...
Index1_1 <- add.constraint(Index1_1, type="long_only")
Index1_1 <- add.constraint(Index1_1, type = "box", min=0.00, max=1.00)
...
Index2_1 <- add.constraint(Index2_1, type="long_only")
Index2_1 <- add.constraint(Index2_1, type = "box", min=0.00, max=1.00)
...
Index3_1 <- add.constraint(Index3_1, type="long_only")
Index3_1 <- add.constraint(Index3_1, type = "box", min=0.00, max=1.00)
...
Index4_1 <- add.constraint(Index4_1, type="long_only")
Index4_1 <- add.constraint(Index4_1, type = "box", min=0.00, max=1.00)
...
Index5_1 <- add.constraint(Index5_1, type="long_only")
Index5_1 <- add.constraint(Index5_1, type = "box", min=0.00, max=1.00)
...
Index6_1 <- add.constraint(Index6_1, type="long_only")
Index6_1 <- add.constraint(Index6_1, type = "box", min=0.00, max=1.00)

Index7_1 <- add.constraint(Index7_1, type="weight_sum", min_sum=0.9999999, max_sum=1.00000001, indexnum = 1)
Index7_1 <- add.objective(Index7_1, type="return", name="mean")
Index7_1 <- add.objective(Index7_1, type="risk", name="StdDev")
Index7_1 <- add.constraint(Index7_1, type="long_only")
Index7_1 <- add.constraint(Index7_1, type = "box", min=0.00, max=1.00)
...
Index8_1 <- add.constraint(Index8_1, type="long_only")
Index8_1 <- add.constraint(Index8_1, type = "box", min=0.00, max=1.00)
...
Index9_1 <- add.constraint(Index9_1, type="long_only")
Index9_1 <- add.constraint(Index9_1, type = "box", min=0.00, max=1.00)
...
Index10_1 <- add.constraint(Index10_1, type="long_only")
Index10_1 <- add.constraint(Index10_1, type = "box", min=0.00, max=1.00)
...
Index11_1 <- add.constraint(Index11_1, type="long_only")
Index11_1 <- add.constraint(Index11_1, type = "box", min=0.00, max=1.00)
...
Index12_1 <- add.constraint(Index12_1, type="long_only")
Index12_1 <- add.constraint(Index12_1, type = "box", min=0.00, max=1.00)
...
chart.Weights(Baselineport, main="Rebalanced Weights Over Time Baseline")
chart.Weights(Index1port, main="Rebalanced Weights Over Time Index 1")
chart.Weights(Index2port, main="Rebalanced Weights Over Time Index 2")
chart.Weights(Index3port, main="Rebalanced Weights Over Time Index 3")
chart.Weights(Index4port, main="Rebalanced Weights Over Time Index 4")
chart.Weights(Index5port, main="Rebalanced Weights Over Time Index 5")
chart.Weights(Index6port, main="Rebalanced Weights Over Time Index 6")
chart.Weights(Index7port, main="Rebalanced Weights Over Time Index 7")
chart.Weights(Index8port, main="Rebalanced Weights Over Time Index 8")
chart.Weights(Index9port, main="Rebalanced Weights Over Time Index 9")
chart.Weights(Index10port, main="Rebalanced Weights Over Time Index 10")
chart.Weights(Index11port, main="Rebalanced Weights Over Time Index 11")
chart.Weights(Index12port, main="Rebalanced Weights Over Time Index 12")

#Define 1/N portfolio
equal_weight <- rep(1 / ncol(Portfolio0ret), ncol(Portfolio0ret))
equal_weight1 <- rep(1/ ncol(Portfolio1ret), ncol(Portfolio1ret))
Naive <- Return.portfolio(Portfolio0ret, weights = equal_weight, geometric = FALSE)
Naive1 <- Return.portfolio(Portfolio1ret, weights = equal_weight1, geometric = FALSE)
Naive2 <- Return.portfolio(Portfolio2ret, weights = equal_weight1, geometric = FALSE)
Naive3 <- Return.portfolio(Portfolio3ret, weights = equal_weight1, geometric = FALSE)
Naive4 <- Return.portfolio(Portfolio4ret, weights = equal_weight1, geometric = FALSE)
Naive5 <- Return.portfolio(Portfolio5ret, weights = equal_weight1, geometric = FALSE)
Naive6 <- Return.portfolio(Portfolio6ret, weights = equal_weight1, geometric = FALSE)
Naive7 <- Return.portfolio(Portfolio7ret, weights = equal_weight1, geometric = FALSE)
Naive8 <- Return.portfolio(Portfolio8ret, weights = equal_weight1, geometric = FALSE)
Naive9 <- Return.portfolio(Portfolio9ret, weights = equal_weight1, geometric = FALSE)
Naive10 <- Return.portfolio(Portfolio10ret, weights = equal_weight1, geometric = FALSE)
Naive11 <- Return.portfolio(Portfolio11ret, weights = equal_weight1, geometric = FALSE)
Naive12 <- Return.portfolio(Portfolio12ret, weights = equal_weight1, geometric = FALSE)
colnames(Naive) <- "1 over N Portfolio"
colnames(Naive1) <- "1 over N Portfolio1"
colnames(Naive2) <- "1 over N Portfolio2"
colnames(Naive3) <- "1 over N Portfolio3"
colnames(Naive4) <- "1 over N Portfolio4"
colnames(Naive5) <- "1 over N Portfolio5"
colnames(Naive6) <- "1 over N Portfolio6"
colnames(Naive7) <- "1 over N Portfolio7"
colnames(Naive8) <- "1 over N Portfolio8"
colnames(Naive9) <- "1 over N Portfolio9"
colnames(Naive10) <- "1 over N Portfolio10"
colnames(Naive11) <- "1 over N Portfolio11"
colnames(Naive12) <- "1 over N Portfolio12"
...
write.table(rets1_df, file = "Long only returns.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
...
Naive_return1 <- (1+Return.annualized(rets1_df$X1.over.N.Portfolio1, scale = 1, geometric = FALSE))^12-1
Naive_return2 <- (1+Return.annualized(rets1_df$X1.over.N.Portfolio2, scale = 1, geometric = FALSE))^12-1
Naive_return3 <- (1+Return.annualized(rets1_df$X1.over.N.Portfolio3, scale = 1, geometric = FALSE))^12-1
Naive_return4 <- (1+Return.annualized(rets1_df$X1.over.N.Portfolio4, scale = 1, geometric = FALSE))^12-1
Naive_return5 <- (1+Return.annualized(rets1_df$X1.over.N.Portfolio5, scale = 1, geometric = FALSE))^12-1
Naive_return6 <- (1+Return.annualized(rets1_df$X1.over.N.Portfolio6, scale = 1, geometric = FALSE))^12-1
Naive_return7 <- (1+Return.annualized(rets1_df$X1.over.N.Portfolio7, scale = 1, geometric = FALSE))^12-1
Naive_return8 <- (1+Return.annualized(rets1_df$X1.over.N.Portfolio8, scale = 1, geometric = FALSE))^12-1
Naive_return9 <- (1+Return.annualized(rets1_df$X1.over.N.Portfolio9, scale = 1, geometric = FALSE))^12-1
Naive_return10 <- (1+Return.annualized(rets1_df$X1.over.N.Portfolio10, scale = 1, geometric = FALSE))^12-1
Naive_return11 <- (1+Return.annualized(rets1_df$X1.over.N.Portfolio11, scale = 1, geometric = FALSE))^12-1
Naive_return12 <- (1+Return.annualized(rets1_df$X1.over.N.Portfolio12, scale = 1, geometric = FALSE))^12-1
...
Naive1_Std. <- StdDev(rets1_df$X1.over.N.Portfolio1)*sqrt(12)
Naive2_Std. <- StdDev(rets1_df$X1.over.N.Portfolio2)*sqrt(12)
Naive3_Std. <- StdDev(rets1_df$X1.over.N.Portfolio3)*sqrt(12)
Naive4_Std. <- StdDev(rets1_df$X1.over.N.Portfolio4)*sqrt(12)
Naive5_Std. <- StdDev(rets1_df$X1.over.N.Portfolio5)*sqrt(12)
Naive6_Std. <- StdDev(rets1_df$X1.over.N.Portfolio6)*sqrt(12)
Naive7_Std. <- StdDev(rets1_df$X1.over.N.Portfolio7)*sqrt(12)
Naive8_Std. <- StdDev(rets1_df$X1.over.N.Portfolio8)*sqrt(12)
Naive9_Std. <- StdDev(rets1_df$X1.over.N.Portfolio9)*sqrt(12)
Naive10_Std. <- StdDev(rets1_df$X1.over.N.Portfolio10)*sqrt(12)
Naive11_Std. <- StdDev(rets1_df$X1.over.N.Portfolio11)*sqrt(12)
Naive12_Std. <- StdDev(rets1_df$X1.over.N.Portfolio12)*sqrt(12)
...
Naive_port <- lm(rets1_df$X1.over.N.Portfolio ~ rets1_df$X1.over.N.Portfolio)
Naive_port1 <- lm(rets1_df$X1.over.N.Portfolio1 ~ rets1_df$X1.over.N.Portfolio)
Naive_port2 <- lm(rets1_df$X1.over.N.Portfolio2 ~ rets1_df$X1.over.N.Portfolio)
Naive_port3 <- lm(rets1_df$X1.over.N.Portfolio3 ~ rets1_df$X1.over.N.Portfolio)
Naive_port4 <- lm(rets1_df$X1.over.N.Portfolio4 ~ rets1_df$X1.over.N.Portfolio)
Naive_port5 <- lm(rets1_df$X1.over.N.Portfolio5 ~ rets1_df$X1.over.N.Portfolio)
Naive_port6 <- lm(rets1_df$X1.over.N.Portfolio6 ~ rets1_df$X1.over.N.Portfolio)
Naive_port7 <- lm(rets1_df$X1.over.N.Portfolio7 ~ rets1_df$X1.over.N.Portfolio)
Naive_port8 <- lm(rets1_df$X1.over.N.Portfolio8 ~ rets1_df$X1.over.N.Portfolio)
Naive_port9 <- lm(rets1_df$X1.over.N.Portfolio9 ~ rets1_df$X1.over.N.Portfolio)
Naive_port10 <- lm(rets1_df$X1.over.N.Portfolio10 ~ rets1_df$X1.over.N.Portfolio)
Naive_port11 <- lm(rets1_df$X1.over.N.Portfolio11 ~ rets1_df$X1.over.N.Portfolio)
Naive_port12 <- lm(rets1_df$X1.over.N.Portfolio12 ~ rets1_df$X1.over.N.Portfolio)
...
beta_Naive1 <- Naive_port1$coefficients[2]
beta_Naive2 <- Naive_port2$coefficients[2]
beta_Naive3 <- Naive_port3$coefficients[2]
beta_Naive4 <- Naive_port4$coefficients[2]
beta_Naive5 <- Naive_port5$coefficients[2]
beta_Naive6 <- Naive_port6$coefficients[2]
beta_Naive7 <- Naive_port7$coefficients[2]
beta_Naive8 <- Naive_port8$coefficients[2]
beta_Naive9 <- Naive_port9$coefficients[2]
beta_Naive10 <- Naive_port10$coefficients[2]
beta_Naive11 <- Naive_port11$coefficients[2]
beta_Naive12 <- Naive_port12$coefficients[2]
...
Alpha_Naive <- Naive_return-(Rf+beta_Naive*(Naive_return-Rf))
Alpha_Naive1 <- Naive_return1-(Rf+beta_Naive1*(Naive_return-Rf))
Alpha_Naive2 <- Naive_return2-(Rf+beta_Naive2*(Naive_return-Rf))
Alpha_Naive3 <- Naive_return3-(Rf+beta_Naive3*(Naive_return-Rf))
Alpha_Naive4 <- Naive_return4-(Rf+beta_Naive4*(Naive_return-Rf))
Alpha_Naive5 <- Naive_return5-(Rf+beta_Naive5*(Naive_return-Rf))
Alpha_Naive6 <- Naive_return6-(Rf+beta_Naive6*(Naive_return-Rf))
Alpha_Naive7 <- Naive_return7-(Rf+beta_Naive7*(Naive_return-Rf))
Alpha_Naive8 <- Naive_return8-(Rf+beta_Naive8*(Naive_return-Rf))
Alpha_Naive9 <- Naive_return9-(Rf+beta_Naive9*(Naive_return-Rf))
Alpha_Naive10 <- Naive_return10-(Rf+beta_Naive10*(Naive_return-Rf))
Alpha_Naive11 <- Naive_return11-(Rf+beta_Naive11*(Naive_return-Rf))
Alpha_Naive12 <- Naive_return12-(Rf+beta_Naive12*(Naive_return-Rf))
...
Trey_Naive1 <- Naive_return1/Naive_port1$coefficients[2]
Trey_Naive2 <- Naive_return2/Naive_port2$coefficients[2]
Trey_Naive3 <- Naive_return3/Naive_port3$coefficients[2]
Trey_Naive4 <- Naive_return4/Naive_port4$coefficients[2]
Trey_Naive5 <- Naive_return5/Naive_port5$coefficients[2]
Trey_Naive6 <- Naive_return6/Naive_port6$coefficients[2]
Trey_Naive7 <- Naive_return7/Naive_port7$coefficients[2]
Trey_Naive8 <- Naive_return8/Naive_port8$coefficients[2]
Trey_Naive9 <- Naive_return9/Naive_port9$coefficients[2]
Trey_Naive10 <- Naive_return10/Naive_port10$coefficients[2]
Trey_Naive11 <- Naive_return11/Naive_port11$coefficients[2]
Trey_Naive12 <- Naive_return12/Naive_port12$coefficients[2]
...
rets2_df = cbind(rets1_df$portfolio.returns,
                 ...
                 rets1_df$X1.over.N.Portfolio1,
                 rets1_df$X1.over.N.Portfolio2,
                 rets1_df$X1.over.N.Portfolio3,
                 rets1_df$X1.over.N.Portfolio4,
                 rets1_df$X1.over.N.Portfolio5,
                 rets1_df$X1.over.N.Portfolio6,
                 rets1_df$X1.over.N.Portfolio7,
                 rets1_df$X1.over.N.Portfolio8,
                 rets1_df$X1.over.N.Portfolio9,
                 rets1_df$X1.over.N.Portfolio10,
                 rets1_df$X1.over.N.Portfolio11,
                 rets1_df$X1.over.N.Portfolio12)
...
maxreturn = round(cbind(max(Baselineport_returns),
                        ...
                        max(rets1_df$X1.over.N.Portfolio),
                        max(rets1_df$X1.over.N.Portfolio1),
                        max(rets1_df$X1.over.N.Portfolio2),
                        max(rets1_df$X1.over.N.Portfolio3),
                        max(rets1_df$X1.over.N.Portfolio4),
                        max(rets1_df$X1.over.N.Portfolio5),
                        max(rets1_df$X1.over.N.Portfolio6),
                        max(rets1_df$X1.over.N.Portfolio7),
                        max(rets1_df$X1.over.N.Portfolio8),
                        max(rets1_df$X1.over.N.Portfolio9),
                        max(rets1_df$X1.over.N.Portfolio10),
                        max(rets1_df$X1.over.N.Portfolio11),
                        max(rets1_df$X1.over.N.Portfolio12)),5)
...
minreturn = round(cbind(min(Baselineport_returns),
                        ...
                        min(rets1_df$X1.over.N.Portfolio),
                        min(rets1_df$X1.over.N.Portfolio1),
                        min(rets1_df$X1.over.N.Portfolio2),
                        min(rets1_df$X1.over.N.Portfolio3),
                        min(rets1_df$X1.over.N.Portfolio4),
                        min(rets1_df$X1.over.N.Portfolio5),
                        min(rets1_df$X1.over.N.Portfolio6),
                        min(rets1_df$X1.over.N.Portfolio7),
                        min(rets1_df$X1.over.N.Portfolio8),
                        min(rets1_df$X1.over.N.Portfolio9),
                        min(rets1_df$X1.over.N.Portfolio10),
                        min(rets1_df$X1.over.N.Portfolio11),
                        min(rets1_df$X1.over.N.Portfolio12)),5)
...
losing = round(cbind(nrow(rets1_df[rets1_df$portfolio.returns<0]),
                     ...
                     nrow(rets1_df[rets1_df$X1.over.N.Portfolio<0]),
                     nrow(rets1_df[rets1_df$X1.over.N.Portfolio1<0]),
                     nrow(rets1_df[rets1_df$X1.over.N.Portfolio2<0]),
                     nrow(rets1_df[rets1_df$X1.over.N.Portfolio3<0]),
                     nrow(rets1_df[rets1_df$X1.over.N.Portfolio4<0]),
                     nrow(rets1_df[rets1_df$X1.over.N.Portfolio5<0]),
                     nrow(rets1_df[rets1_df$X1.over.N.Portfolio6<0]),
                     nrow(rets1_df[rets1_df$X1.over.N.Portfolio7<0]),
                     nrow(rets1_df[rets1_df$X1.over.N.Portfolio8<0]),
                     nrow(rets1_df[rets1_df$X1.over.N.Portfolio9<0]),
                     nrow(rets1_df[rets1_df$X1.over.N.Portfolio10<0]),
                     nrow(rets1_df[rets1_df$X1.over.N.Portfolio11<0]),
                     nrow(rets1_df[rets1_df$X1.over.N.Portfolio12<0])),5)
...
write.zoo(Returns_excess, file = "Excess montly Long Only.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(Returns_excess_Annual, file = "Annual Excess Long Only.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(Std.dev_excess_Annual, file = "Annual Excess std Long Only.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(maxreturn, file = "Maxreturn Long Only.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(minreturn, file = "Minreturn Long Only.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(maxdrawdown, file = "MaxDrawdown Long Only.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(losing, file = "Losing months Long Only.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
