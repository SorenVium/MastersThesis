...
write.table(rets1_df, file = "Risk Unconstrained returns.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
...
#Export results
write.zoo(Exportweights, file = "Unconstrained w. risk aversion weights.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.table(Returns, file = "Unconstrained w. risk aversion mean returns.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.table(Returns_Annual, file = "Unconstrained w. risk aversion Annual returns.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.table(Std.annual, file = "Unconstrained w. risk aversion Annual std..txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.table(Sharpe_Annual, file = "Unconstrained w. risk aversion Annual sharpe.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(Treynor_Annual, file = "Treynor Unconstrained w. risk aversion.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(Alphadf, file = "Alpha Unconstrained w. risk aversion.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(Returns_excess, file = "Excess montly Unconstrained w. risk aversion.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(Returns_excess_Annual, file = "Annual Excess Unconstrained w. risk aversion.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(Std.dev_excess_Annual, file = "Annual Excess std Unconstrained w. risk aversion.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(maxreturn, file = "Maxreturn Unconstrained w. risk aversion.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(minreturn, file = "Minreturn Unconstrained w. risk aversion.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(maxdrawdown, file = "MaxDrawdown Unconstrained w. risk aversion.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(losing, file = "Losing months Unconstrained w. risk aversion.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
