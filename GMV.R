...
#Export results
write.zoo(Exportweights, file = "GMV weights.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.table(Returns, file = "GMV mean returns.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.table(Returns_Annual, file = "GMV Annual returns.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.table(Std.annual, file = "GMV Annual std..txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.table(Sharpe_Annual, file = "GMV Annual sharpe.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(Treynor_Annual, file = "Treynor GMV.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(Alphadf, file = "Alpha GMV.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(Returns_excess, file = "Excess montly GMV.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(Returns_excess_Annual, file = "Annual Excess GMV.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(Std.dev_excess_Annual, file = "Annual Excess std GMV.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(maxreturn, file = "Maxreturn GMV.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(minreturn, file = "Minreturn GMV.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(maxdrawdown, file = "MaxDrawdown GMV.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
write.zoo(losing, file = "Losing months GMV.txt", col.names = TRUE, row.names = FALSE, sep = "\t")
